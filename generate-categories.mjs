...
const CATS = [
  ...
  },
  {
    slug: "klima-hurdasi",
    title: "Klima Hurdası",
    metaTitle: "Mersin Klima Hurdası Alımı",
    desc: "Split, salon tipi ve VRF klimalarınızın iç/dış ünitesini söküp bakır/alüminyum radyatör değerine göre alıyoruz.",
    img: "mersin-is-makinesi.avif",
    lead: "Klima üniteleri, içerdiği bakır radyatör ve kompresör nedeniyle değerli bir hurda kalemidir. Arısoy Metal olarak klimanızın sökümünü de üstlenip, yerinde tartıp ödemesini yapıyoruz.",
    types: [
...
<meta property="og:title" content="${cat.metaTitle} | ${BRAND}">
...
<div class="nav-overlay"></div><section class="phero"><div class="container">
  ...
  <h1>Mersin ${cat.title} Alımı</h1><p>${cat.desc}</p>
</div></section><section class="content"><div class="container content-grid">
      <div class="prose reveal">
        <img src="img/${cat.img}" alt="Mersin ${cat.title.toLowerCase()} - ${BRAND}" width="960" height="640" fetchpriority="high" decoding="async">
