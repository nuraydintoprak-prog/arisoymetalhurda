/* ===================================================================
   Arısoy Metal Geri Dönüşüm Hurdacılık - main.js
=================================================================== */
(function () {
  'use strict';
  var WA = '905308311056';      // WhatsApp numarası
  var TEL = '+905308311056';    // Telefon
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('form[data-wa]').forEach(function (form) {
      form.addEventListener('submit', function (e) {
        ...
        var t = '*Yeni Bilgi Talebi - Arısoy Metal*%0A%0A';
        t += '👤 Ad Soyad: ' + ad + '%0A';
        t += '📞 Telefon: ' + tel + '%0A';
